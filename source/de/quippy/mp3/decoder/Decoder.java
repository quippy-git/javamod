...
public class Decoder implements DecoderErrors
{
	 ...
	 */
	public Obuffer decodeFrame(final Header header, final Bitstream stream)
	...
	protected FrameDecoder retrieveDecoder(final Header header, final Bitstream stream, final int layer)
		throws DecoderException
	{
