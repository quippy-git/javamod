...
public class JavaLayerUtils
{
	 ...
	 */
	static public Object deserialize(final InputStream in, final Class<?> cls)
		throws IOException
	{
		if (cls==null)
	 ...
	 */
	static public Object deserialize(final InputStream in)
		throws IOException
	{
		if (in==null)
	 ...
	 */
	static public Object deserializeArray(final InputStream in, final Class<?> elemType, final int length)
		throws IOException
	{
		if (elemType==null)
	...
	static public Object deserializeArrayResource(final String name, final Class<?> elemType, final int length)
		throws IOException
	{
	...
	static public void serialize(final OutputStream out, final Object obj)
		throws IOException
	{
		if (out==null)
	 ...
	 */
	static synchronized public void setHook(final JavaLayerHook hook0)
	{
		hook = hook0;
	}
	 ...
	 */
	static synchronized public InputStream getResourceAsStream(final String name)
	{
		InputStream is = null;
		...
		{
			final Class<JavaLayerUtils> cls = JavaLayerUtils.class;
