...
public class SIDEndian {
	...
	public static final int /* uint_least16_t */endian_16lo8(
			int /* uint_least16_t */word, final short /* uint8_t */thebyte) {
		word &= 0xff00;
		word |= thebyte;
		return word;
	}
	...
	public static final int /* uint_least16_t */endian_16swap8(
		...
		final short /* uint8_t */lo = endian_16lo8(word);
		final short /* uint8_t */hi = endian_16hi8(word);
		word = 0;
	...
	public static final int /* uint_least16_t */endian_16(
			final short /* uint8_t */hi, final short /* uint8_t */lo) {
	 ...
	 * @return
	 */
	public static final void endian_16(final short /* uint8_t */ptr[], final int pos,
			final int /* uint_least16_t */word) {
...
//		}
	...
	public static final void endian_16(final char ptr[], final int pos,
			final int /* uint_least16_t */word) {
		final short[] newptr = new short /* uint8_t */[] {
	...
	public static final int /* uint_least16_t */endian_little16(
			final short /* uint8_t */ptr[], final int pos) {
	 ...
	 * @param word
	 */
	public static final void endian_little16(final short /* uint8_t */ptr[],
			final int pos, final int /* uint_least16_t */word) {
		ptr[pos + 0] = endian_16lo8(word);
		ptr[pos + 1] = endian_16hi8(word);
	}
	 ...
	 * @param word
	 */
	public static final void endian_big16(final short /* uint8_t */ptr[], final int pos,
			final int /* uint_least16_t */word) {
		ptr[pos + 0] = endian_16hi8(word);
		ptr[pos + 1] = endian_16lo8(word);
	}
	...
	public static final long /* uint_least32_t */endian_32lo16(
			long /* uint_least32_t */dword, final int /* uint_least16_t */word) {
		dword &= 0xffff0000;
		dword |= word;
		return dword;
	}
	...
	public static final int /* uint_least16_t */endian_32lo16(
			final long /* uint_least32_t */dword) {
	...
	public static final long /* uint_least32_t */endian_32lo8(
			long /* uint_least32_t */dword, final short /* uint8_t */theByte) {
		dword &= 0xffffff00;
		dword |= theByte;
		return dword;
	}
	...
	public static final long /* uint_least32_t */endian_32swap16(
		...
		final int /* uint_least16_t */lo = endian_32lo16(dword);
		final int /* uint_least16_t */hi = endian_32hi16(dword);
	...
	public static final long /* uint_least32_t */endian_32(
			final short /* uint8_t */hihi, final short /* uint8_t */hilo,
			final short /* uint8_t */hi, final short /* uint8_t */lo) {
	 ...
	 * @param dword
	 */
	public static final void endian_little32(final short /* uint8_t */ptr[],
			final int pos, final long /* uint_least32_t */dword) {
		int /* uint_least16_t */word = 0;
	 ...
	 * @param dword
	 */
	public static final void endian_big32(final short /* uint8_t */ptr[], final int pos,
			final long /* uint_least32_t */dword) {
		int /* uint_least16_t */word = 0;
		word = endian_32hi16(dword);
		ptr[pos + 1] = endian_16lo8(word);
